...
The goal of this report is on one hand to explore the current literature about platforms applying the \gls{FaaS} paradigm to the Fog. And on a second hand to explore the work done during the internship from the 7\textsuperscript{th} of February to the 31\textsuperscript{st} of July.
...
\end{enumerate*}
Moreover, as this is a research work, we expect “scientific comparison” to part of the list.
...
\begin{description}
	\item[Step 0]{(\cref{fig:our_placement0}) simply answers to the question: “How does the application is made aware that the necessary \gls{IoT} devices have joined to run properly?”
...
\subsubsection{Evaluating our solution}
...
Economic efficiency aims to examine whether the Fog node earns enough “money” to be lucrative for its owner. Profitability of a node would be an incentive to stay in the network. One experience could look at “what happens when unremunerative nodes leave the grid because they went bankrupt?”
...
\subsection{Evolutions and future research work}
