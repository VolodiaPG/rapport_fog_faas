...
Considering this ownership of fog nodes, as proposed earlier, a good mechanism to introduce contest in a controlled, independent and objective manner are auctions. \improvement{Add info about benefits and properties of auctions}
...
\begin{description}
	...
	\item[Step 2 (\cref{fig:our_placement2})] {is the bidding process. Every fog node looks at the \gls{SLA} and bids. Thanks to an appropriate \improvement{Ref the appropriate auction mecha} auctioning mechanism, it will represent the actual value—the truthful value—of the function through the eyes of the Fog node. Once this process has been done, the bid is returned to the Marketplace.}
