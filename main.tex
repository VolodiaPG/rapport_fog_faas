...
\begin{itemize}
	...
	\item Extendability through the utilization of WebAssembly in order to integrate modules that modify the behavior of the platform, for instance this would be especially useful for the decision-taking process on Fog nodes to give a bid. This would allow other languages than Rust on a small parcel of the software. Thus making the tester comfortable and keeping the clean practice of Rust processing the resulting data.
\end{itemize}
