...
I coded this framework in Rust. The use of this innovative language present several benefits, in no order:\improvement{Put an order}
\begin{itemize}
	...
	\item Rust is efficient without being a low-level coding language such as C, making it ideal if the framework needs to accomplish high efficiency tasks such as routing \improvement{Add a citation to the appropriate section}.
	\item 
\end{itemize}
...
\todo{finish correcting from here}
