...
Placing functions is a challenge. Adding that Fog nodes are independent actors that choose to join the network adds a difficulty layer: fog nodes are able to specify their prices. Auctions help to make sure competition is maintained and as such prices are not artificial \change{Specify what is the danger of having artificial prices}
